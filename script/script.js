...
function start() {
    ...
    communicationBoxEl.innerText = 'I Have a number berween 1 to 100. Enter your guess bellow !!'
    guessBtnEl.classList.add('show')
    numberInputEl.classList.add('show');
    computerGuess = (Math.round(Math.random() * 98)) + 1;
...
function compareWithGuess() {
    ...
    if (numberInputVl>0 && numberInputVl < 101) {
        ...
        alert('Enter a valid Number between 1 to 99 to play')
    }
}